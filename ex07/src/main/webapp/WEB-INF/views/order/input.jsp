...
<h1>注文書入力</h1>
<form id="orderForm" method="post" action="<c:url value='/order/save'/>">
    <!-- 注文書基本情報 -->
<fieldset>
    <legend>注文書基本情報</legend>
    ...
    <label>出荷倉庫:</label>
    <select name="soukoID">
        <option value="">出荷倉庫を選択してください</option>
    ...
    <select name="zeikomikubun" required>
        <option value="Y" selected>消費税含む</option>
        <option value="N">消費税含まない</option>
    </select>

    <label>通貨:</label>
    <select name="tsukaID" required>
        <option value="">通貨を選択してください</option>
    ...
    <label>納期日付:</label>
    <input type="date" name="noukiIchija" required>
