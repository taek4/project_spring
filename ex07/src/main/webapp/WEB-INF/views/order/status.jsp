		...
		<form class="filter-form" id="statusForm" method="post"
			...
			<div class="form-row">
				...
				<div class="form-group">
					<label>通貨:</label> <select class="form-input" name="tsukaID">
			...
			<div class="form-row">
				...
				<div class="form-group">
					<label>税金区分:</label><select class="form-input" name="zeikomikubun">
						<option value="Y" selected>付加税込み</option>
						<option value="N">付加税除外</option>
					</select>
				</div>
			</div>
			...
			<div class="form-row">
				<div class="form-group date-range">
					<label for="noukiBi_kaishi">納期日:</label> <input
						class="form-input-top" type="date" id="noukiichija_kaishi"
						name="noukiichija_kaishi" value="${param.noukiBi_kaishi}"
						pattern="\\d{4}/\\d{2}/\\d{2}" placeholder="yyyy/mm/dd" /> <label
						for="noukiBi_shuuryou">~</label> <input class="form-input-top"
						type="date" id="noukiichija_shuuryou" name="noukiichija_shuuryou"
						value="${param.noukiBi_shuuryou}" pattern="\\d{4}/\\d{2}/\\d{2}"
